(custom-set-variables
 ...
 '(cc-search-directories (quote ("../include" "../src" "." "/usr/include" "/usr/local/include/*")))
...
(custom-set-faces
 ...
 '(elscreen-tab-current-screen-face ((t (:background "OrangeRed2"))))
 '(elscreen-tab-other-screen-face ((t (:background "gray42"))))
