...
* TODO oom killer and low memory killer                                :work:
:PROPERTIES:
...
* TODO `with-current-buffer` style asynctask in android?               :work:
...
* TODO Http the definitive guide                               :work:reading:
...
* TODO InputDispatcher & InputManagerService & InputFilter             :work:
...
* TODO listview fling 时有后退的错觉? 这是抽样定理在作怪么?            :work:
